...
import com.online.voting.voting.clients.feedback.PositionCleintFallbackFactory;
import com.online.voting.voting.dtos.ApiResponse;
import com.online.voting.voting.dtos.PositionResponse;

@FeignClient(name = "api-gateway", url = "http://localhost:8080", fallbackFactory = PositionCleintFallbackFactory.class)
